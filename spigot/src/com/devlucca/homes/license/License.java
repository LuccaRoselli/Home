package com.devlucca.homes.license;
...
public class License {
	...
	public static String plugin_name = Main.getInstance().getName();
	...
	public boolean check() {
		...
		for (LicenseObject lo : LicenseObject.getLicenses()) {
			if (lo.getLicense().trim().equalsIgnoreCase(Main.getInstance().getConfig().getString("Licenca"))) {
				if (!lo.isPrivate()) {
