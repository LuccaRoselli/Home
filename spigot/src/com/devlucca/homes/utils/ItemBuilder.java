...
public class ItemBuilder
{
	...
	public ItemBuilder glow(boolean b) {
		if (b)
			return makeNBTStack(this.is, true, is.getItemMeta().getDisplayName(), is.getItemMeta().getLore());
		else
			return this;
	}

	private ItemBuilder makeNBTStack(ItemStack item, boolean enchanted, String name, List<String> lore) {
		try {
			...
			this.is = (org.bukkit.inventory.ItemStack) asCraftMirror.invoke(null, nmsStack);
			return this;
		} catch (Exception e) {
			e.printStackTrace();
			return this;
